        ...
        items: [
          ...
          { text: 'Branding', link: '/branding' },
          {
            ...
            items: [
              ...
              { text: `center`, link: '/layouts/center' },
          ...
          },
          {
            ...
            items: [
              ...
              { text: 'Quote / QuoteFence', link: '/components/quote' },
              { text: 'MapFigure', link: '/components/mapfigure' },
              { text: 'Morph', link: '/components/morph' },
              { text: 'NWPLogo', link: '/components/nwplogo' },
            ],
          },
