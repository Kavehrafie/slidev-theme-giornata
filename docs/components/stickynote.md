...
- `color` (optional) can be any of the [color scheme](/colors) options. If not provided, the default color is `amber`.
...
```vue
<StickyNote color="amber" textAlign="left" width="180px" title="Title">
...
Renders as:
<StickyNote color="teal" width="200px" title="Custom Styled" custom="text-lg font-bold text-center" customTitle="text-red-500 text-lg">
This content has custom styling applied.
</StickyNote>
...
```vue
<StickyNote color="pink" textAlign="left" width="180px" title="Title">
  Hello, I'm a **sticky note**.
</StickyNote>
```
...
```vue
<StickyNote color="amber" width="180px" title="Note to self" devOnly>
