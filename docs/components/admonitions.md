...
```vue
<Admonition title="Info" color="teal" width="300px">
...
```vue
<Admonition title="Custom Styled" color="purple" custom="text-lg font-bold" customTitle="text-red-500">
...
```vue
<Admonition title="V-draggable" color="teal" width="300px" v-drag>
This is my admonition content.
</Admonition>
```
