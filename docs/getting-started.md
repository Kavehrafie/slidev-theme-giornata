# Getting started with Giornata

The theme depends on Node.js and [Slidev](https://sli.dev). If you don't have Node.js installed, you can download it from [nodejs.org](https://nodejs.org/). Once you have Node.js installed, you can create a new Slidev project with the Giornata theme by running the following command:

```bash
npm init slidev@latest
```

Then answer the sequence of questions. When it asks for the theme select `giornata`.
...
## Read on about all the Giornata features

- [Markdown features](markdown.md) - special addons to the Slidev markdown syntax
- [Color schemes](colors.md) - the color schemes available in Giornata
...
- [Styling](styling.md) - the custom CSS classes available in Giornata
- [Custom layouts](layouts.md) - the custom slide layouts available in Giornata
